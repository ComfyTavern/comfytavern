<template>
  <div ref="rootRef" class="select-input relative w-full">
    ...
    <!-- Suggestion Dropdown -->
    <SuggestionDropdown :suggestions="normalizedSuggestions" :show="isDropdownVisible" :position="dropdownPosition"
      :target-element="rootRef" :trigger-width="dropdownWidth" :canvas-scale="currentCanvasScale" :size="props.size"
      :searchable="props.searchable" @select="handleSuggestionSelect" @close="closeDropdown" />
...
const selectedOptionLabel = computed(
  () =>
    normalizedSuggestions.value.find((o) => o.value === props.modelValue)?.label ??
    props.modelValue ??
    null
);
