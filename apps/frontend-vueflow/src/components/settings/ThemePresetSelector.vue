<template>
  <div class="theme-preset-selector">
    ...
    <select
      ...
      class="block w-full pl-3 pr-10 py-2 text-base border-border-base focus:outline-none focus:ring-primary focus:border-primary sm:text-sm rounded-md bg-background-surface text-text-base"
    >
