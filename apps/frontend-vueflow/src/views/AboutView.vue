<template>
  <div
    ...
    <OverlayScrollbarsComponent :options="{
      ...
      <!-- 主要内容区域 -->
      <div class="p-6 lg:p-10 max-w-screen-2xl mx-auto transition-all duration-500 ease-in-out"
...
.fancy-underline::after {
  ...
  width: 100%;
  height: 3px;
  background: linear-gradient(90deg, var(--tw-gradient-from, #3b82f6), var(--tw-gradient-to, #a855f7));
  transform: scaleX(0);
...
.dark .fancy-underline::after {
  background: linear-gradient(90deg, var(--tw-gradient-from, #60a5fa), var(--tw-gradient-to, #c084fc));
}
