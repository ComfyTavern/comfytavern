...
//   CreateWorkflowObjectSchema,
//   UpdateWorkflowObjectSchema,
//   type WorkflowObject,
//   type GroupInterfaceInfo,
//   type WorkflowNode,
//   type NodeGroupData
// } from '@comfytavern/types';
// import { nodeManager } from './nodes/NodeManager'; // 保留，可能被其他路由间接使用
...
// import isEqual from 'lodash/isEqual'; // 移除未使用的 isEqual
import { NodeLoader } from './nodes/NodeLoader';
// import { ExecutionEngine } from './ExecutionEngine'; // 移除未使用的 ExecutionEngine
// 移除未使用的 helpers
// import {
//   sanitizeProjectId,
...
// 移除未使用的 projectService 函数
// import { getProjectWorkflowsDir, syncReferencingNodeGroups } from './services/projectService';
...
// --- 启动服务器 ---
app.listen(PORT, (server) => { // 使用 listen 回调获取 server 实例
  if (server) {
