...
- **[`RandomNumberNode.ts`](../../../../apps/backend/src/nodes/Utilities/RandomNumberNode.ts:1)** (`core:RandomNumber`)
  - **功能**：生成和操作一个 32 位随机整数。其核心逻辑主要在前端通过 [`clientScriptUrl`](../../../../apps/backend/src/nodes/Utilities/RandomNumberNode.ts:66) ([`client-scripts/RandomNumberNode.js`](../../../../apps/backend/src/nodes/Utilities/client-scripts/RandomNumberNode.js:1)) 执行。后端 `execute` 仅作为数据通道或处理简单逻辑。
